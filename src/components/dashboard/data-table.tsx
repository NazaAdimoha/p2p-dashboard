          ...
          <div className="w-full md:w-auto flex items-center gap-2">
            {activeFilter && (
              <div className="flex-1 md:flex-initial flex items-center gap-2">
                <Input
                  ...
                  value={(columnFilters.find(f => f.id === activeFilter)?.value as string) || ""}
                  onChange={(e) => handleColumnFilter(activeFilter, e.target.value)}
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-48">
                <div className="p-2">
                  <div className="text-sm font-semibold mb-2">Filter by column</div>
                  {table
                    .getAllColumns()
                    ...
                    .map((column) => (
                      <DropdownMenuCheckboxItem
                        ...
                        onCheckedChange={() => setActiveFilter(activeFilter === column.id ? null : column.id)}
                      >
                        {column.id}
                      </DropdownMenuCheckboxItem>
                    ))}
