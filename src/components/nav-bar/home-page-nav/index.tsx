    ...
    <nav className="bg-[#0A0A0F] backdrop-blur-lg border-b border-[#2A2A35]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          <Link href="/" className="text-2xl font-bold bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent hover:opacity-90 transition-opacity">
            PeerPay
          </Link>
          ...
          <div className="flex items-center space-x-6">
            ...
            <SignedOut>
              <div className="flex items-center space-x-4">
                ...
                <Link
                  href="/sign-up"
                  className="bg-gradient-to-r from-primary to-secondary text-white px-6 py-2.5 rounded-xl font-medium
